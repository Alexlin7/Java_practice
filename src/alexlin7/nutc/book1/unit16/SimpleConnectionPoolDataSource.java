...
public class SimpleConnectionPoolDataSource implements DataSource{
    ...
    public SimpleConnectionPoolDataSource(String configFile)
        ...
        url = props.getProperty("alexlin7.localhost.url");
        username = props.getProperty("alexlin7.localhost.username");
        password = props.getProperty("alexlin7.localhost.password");
        max = Integer.parseInt(props.getProperty("alexlin7.localhost.poolmax"));
