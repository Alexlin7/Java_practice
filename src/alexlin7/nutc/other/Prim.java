...
public class Prim {
    public static List<Vertex> vertexList = new ArrayList<>();//结点集
    public static List<Edge> EdgeQueue = new ArrayList<>();//边集
    public static List<Vertex> newVertex = new ArrayList<>();//已经 访问过的结点
